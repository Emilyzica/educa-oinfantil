...
const closeDrawerBtn = document.getElementById('closeDrawer'); // Adicionando o botão de fechar
...
menuBtn?.addEventListener('click', () => toggleDrawer()); // Abertura do menu
closeDrawerBtn?.addEventListener('click', () => toggleDrawer(false)); // Fechar o menu
...
const animateBars = () => {
  bars.forEach((b, i) => {
    ...
    b.style.height = '0%';
    b.animate([{ height: '0%' }, { height: target + '%' }], {
      duration: 900 + i * 200,
