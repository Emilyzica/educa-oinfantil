...
const perfilDiv = document.getElementById("perfil");
  ...
  addFilhoBtn.addEventListener('click', () => {
    modal.classList.remove('hidden');
  ...
  window.fecharModal = fecharModal; // Tornar a função global para uso inline no HTML
  window.editarFilho = editarFilho; // Tornar a função global para uso inline no HTML
  window.excluirFilho = excluirFilho; // Tornar a função global para uso inline no HTML
  window.registrarLeitura = registrarLeitura; // Tornar a função global para uso inline no HTML 
